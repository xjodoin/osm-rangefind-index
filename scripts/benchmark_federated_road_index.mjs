...
// Live production smoke/latency benchmark for client-only inter-region roads.
// The default pair crosses Quebec -> Ontario; override catalog/profile with:
//   node scripts/benchmark_federated_road_index.mjs <catalog> <profile>
...
const from = { lat: 45.5019, lon: -73.5674 };
const to = { lat: 43.6532, lon: -79.3832 };
