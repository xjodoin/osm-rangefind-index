...
const output = {
  ...
  partitionReducerWorkers: existing.partitionReducerWorkers ?? 8,
  codeStoreWorkerPreloadMaxBytes: existing.codeStoreWorkerPreloadMaxBytes ?? 3 * 1024 ** 3,
  acquisitionConcurrency: existing.acquisitionConcurrency ?? 2,
  largePbfBytes: existing.largePbfBytes ?? 1024 ** 3,
  roadIndexes: existing.roadIndexes,
